...
if __name__ == "__main__":
    ...
    # Load one user, make changes and save changes to db
    test_user_3 = User.load_user_by_id(cnx_cursor[1], 3)
    test_user_3.set_password("qwertyuiop", models.hasher.generate_salt())
    test_user_3.save_to_db(cnx_cursor[1])

    # Load one user, delete that user
    test_user_4 = User.load_user_by_id(cnx_cursor[1], 20)
    test_user_4.delete(cnx_cursor[1])
